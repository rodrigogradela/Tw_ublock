/*******************************************************************************
    ...
    Copyright (C) 2024-present Gradela
    ...
    Home: https://github.com/rodrigogradela
*/
...
// Adicionando o filtro `twitch.tv##+js(twitch-videoad)`
(async () => {
    const filtro = 'twitch.tv##+js(twitch-videoad)';
    const options = { autoComment: true, docURL: 'https://twitch.tv' };

    try {
        await µb.appendUserFilters(filtro, options);
        console.log('Filtro adicionado com sucesso:', filtro);
    } catch (err) {
        console.error('Erro ao adicionar o filtro:', err);
    }
})();
